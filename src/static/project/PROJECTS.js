export const PROJECTS = [
  {
    NAME: "Planting",
    STACK: "Java, Spring Boot, Jenkins, Tomcat, Docker, Git, Maven, MariaDB",
    DUE: "2023.02 - 2023.06",
    DESCRIPTION: "스마트 플랜트 플랫폼",
    TASK: [
      {
        PART: "백엔드 개발 (Java, Spring Boot, Jenkins, Tomcat, and others)",
        DESCRIPTION: ["플랫폼 백엔드 전반 담당"],
      },
    ],
    TAGS: {
      TEAM_YN: "Y",
    ...
    DEMO_URL: "http://www.dayounghan.com/api",
    GITHUB_URL: "https://github.com/crazy-oung/planttech.git",
    IMG_SRC: "/assets/image/project/planting.png",
    IMG_ALT: "플랜팅 이미지",
  },
  {
    NAME: "Hangang",
